        ...
        <AreaChart data={data} margin={{ top: 20, right: 60, left: 20, bottom: 20 }}>
          <defs>
            <linearGradient id="colorScheduled" x1="0" y1="0" x2="0" y2="1">
              <stop offset="5%" stopColor="#ece9e9" stopOpacity={0.8} />
              <stop offset="95%" stopColor="#cecbcb" stopOpacity={0} />
            </linearGradient>
          ...
          />
          <YAxis>
            <ReferenceLine y={scheduled} stroke="#f63b3b" strokeDasharray="3 3" />
          </YAxis>
        </AreaChart>
      </ResponsiveContainer>
    </>
