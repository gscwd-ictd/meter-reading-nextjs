...
export const LoadingSplash: FunctionComponent<LoadingSplashProps> = ({ text = "Loading...", show }) => {
  ...
  return (
    <motion.div
      ...
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
      className="absolute inset-0 z-30 flex items-center justify-center bg-white/70 dark:bg-black/30"
    >
      <div className="flex flex-col items-center gap-2 rounded-2xl border bg-white p-6 shadow-lg">
